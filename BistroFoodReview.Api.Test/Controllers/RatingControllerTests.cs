...
public class RatingControllerTests
{
    ...
    [Fact]
    public async Task SaveRating_ShouldReturnNull_WhenRatingIsNotBetween1To5()
    {
        // Arrange
        var options = new DbContextOptionsBuilder<BistroReviewDbContext>()
        .UseInMemoryDatabase(databaseName: Guid.NewGuid().ToString())
      ...
      [Fact]
    public async Task SaveRating_ShouldReturnNull_WhenDateIsNotTodaysDate()
    {
        // Arrange
        var options = new DbContextOptionsBuilder<BistroReviewDbContext>()
        .UseInMemoryDatabase(databaseName: Guid.NewGuid().ToString())
        ...
        var meal = new Meal
            { 
                Id = Guid.NewGuid(),
                Date = DateTime.UtcNow.AddDays(2),                MealOptionId = mealOption.Id,
                MealOption = mealOption,
                EditedMealName = "Test Meal",
                Ratings = new List<Rating>()
            };
